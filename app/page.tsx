    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className="flex items-center mb-6 md:w-[600px]">
        <div className="flex flex-col items-center w-full">
          <div className="h-[200px] bg-[url('/img.jpg')] w-full bg-cover bg-center rounded-3xl mb-6"></div>
          <div className="w-fullp-10 pt-0">
            ...
            <form className="flex items-center w-full">
              <input type="text" className="input input-bordered w-full" placeholder="email@example.com" />
            </form>
          </div>
        </div>
      </div>
